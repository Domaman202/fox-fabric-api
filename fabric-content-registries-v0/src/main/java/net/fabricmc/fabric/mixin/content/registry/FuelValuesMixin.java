...
public abstract class FuelValuesMixin {
	...
	private static FuelValues.Builder build(FuelValues.Builder builder, TagKey<Item> tag, Operation<FuelValues.Builder> operation, @Local HolderLookup.Provider registries, @Local FeatureFlagSet features, @Local int baseSmeltTime) {
