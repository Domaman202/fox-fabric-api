...
public interface FabricItemStack {
	...
	default boolean canBeEnchantedWith(Holder<Enchantment> enchantment, EnchantingContext context) {
		...
		return result.orElseGet(() -> ((FabricItem) ((ItemStack) (Object) this).getItem()).canBeEnchantedWith((ItemStack) (Object) this, enchantment, context));
	}
	...
	default String getCreatorNamespace() {
		return ((FabricItem) ((ItemStack) (Object) this).getItem()).getCreatorNamespace((ItemStack) (Object) this);
	}
}
